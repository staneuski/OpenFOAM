...
:
    ...
    hl_("hl", 512.58, 1644716.30984333, 0.3766, 0, 0, 0),
    Cp_
    (
        "Cp",
        3358.09250358904,
    ...
    mu_("mu", -7.288, 1065.3, -0.6657, 0, 0),
    mug_("mug", 3.0663e-07, 0.69655, 205.0, 0),
    kappa_("kappa", 0.2837, -0.000281, 0, 0, 0, 0),
    kappag_("kappag", -7.763, 1.0279, -74360000.0, 6770000000.0),
    sigma_("sigma", 512.58, 0.04327, 0.7676, 0, 0, 0),
