...
#include "turbulentOmegaFvScalarFieldSource.H"
...
Foam::turbulentOmegaFvScalarFieldSource::
turbulentOmegaFvScalarFieldSource
(
...
turbulentOmegaFvScalarFieldSource
(
    const turbulentOmegaFvScalarFieldSource& field,
    const DimensionedField<scalar, fvMesh>& iF
)
:
...
Foam::turbulentOmegaFvScalarFieldSource::sourceValue
(
    const fvSource& model,
    const DimensionedField<scalar, fvMesh>& source
) const
{
    const DimensionedField<scalar, fvMesh> ks
    (
...
Foam::tmp<Foam::DimensionedField<Foam::scalar, Foam::fvMesh>>
Foam::turbulentOmegaFvScalarFieldSource::internalCoeff
(
    const fvSource& model,
    const DimensionedField<scalar, fvMesh>& source
) const
...
void Foam::turbulentOmegaFvScalarFieldSource::write
(
    Ostream& os
) const
{
